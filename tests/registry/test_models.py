import pytest
from tofusoup.registry.models.provider import Provider, ProviderVersion, ProviderPlatform
...
class TestProviderModels:
    ...
    def test_provider_version_creation(self):
...
class TestModuleModels:
    ...
    def test_module_provider_name_property(self):
