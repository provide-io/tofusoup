...
from tofusoup.harness.logic import ensure_go_harness_build, HarnessBuildError

def test_ensure_go_harness_build_success(tmp_path: Path):
...
def test_ensure_go_harness_build_failure(tmp_path: Path):
