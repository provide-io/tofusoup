...
Feature: replace_within_set

  Scenario: tests the behaviour of an attribute within a set causing a resource to be replaced
    ...
    And the resource has the following attributes:
      ...
      | set | [{"id": "3BFC1A84-023F-44FA-A8EE-EFD88E18B8F7"}, {"id": "07F887E2-FDFF-4B2E-9BFB-B6AA4A05EDB9"}, {"id": "4B7178A8-AB9D-4FF4-8B3D-48B754DE537B"}] |
