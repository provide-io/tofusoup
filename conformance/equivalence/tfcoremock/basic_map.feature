...
Feature: basic_map
  ...
  Scenario: basic test covering creation of a simple map
    ...
    And the resource has the following attributes:
      ...
      | map | {"zero": "6B044AF7-172B-495B-BE11-B9546C12C3BD", "one": "682672C7-0918-4448-8342-887BAE01062A", "two": "212FFBF6-40FE-4862-B708-E6AA508E84E0"} |
