...
class TestCLIParityMatrix:
    ...
    COMMAND_MATRIX = {
        ...
        "": {
            ...
            "expected_subcommands": {"cty", "hcl", "rpc", "harness", "test", "wire", "garnish", "stir", "drink", "state", "workenv", "config"}
        },
        # CTY commands
        "cty": {
            "common_args": {"help"},
        ...
        "hcl": {
            "common_args": {"help"},
            "expected_subcommands": {"view", "convert"}
        },
        "hcl view": {
            "common_args": {"help"},
        },
    ...
    def test_common_arguments_parity(
        ...
        if command_path in self.COMMAND_MATRIX:
            ...
            if missing_common:
                pytest.warns(UserWarning, match=f"Missing common arguments for '{command_path}': {missing_common}")

    def test_root_command_basic_parity(
        self,
        soup_executable: Path, 
        soup_go_executable: Path
    ):
