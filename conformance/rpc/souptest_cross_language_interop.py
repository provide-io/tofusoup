...
class TestCrossLanguageInterop:
    ...
    @pytest.fixture
    def go_server_path(self) -> Optional[str]:
    ...
    @pytest.fixture  
    def go_client_path(self) -> Optional[str]:
...
"""
        ...
        try:
            ...
            cmd = [
                go_client_path,
                "--key", "go-to-python", 
                "--value", "Hello from Go client to Python server!",
                "--server", bridge_path
            ]
            ...
            logger.warning("Go client test timed out - this may be expected due to different interface expectations")
    ...
    async def test_comprehensive_interop_scenario(self, python_server_address: str, go_server_path: Optional[str]):
        ...
        test_data = {
            ...
            "unicode-test": "Hello 世界! 🌍".encode('utf-8'),
