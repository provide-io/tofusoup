...
RPC_TEST_MATRIX = [
    ...
    MTLSConfig(
        name="auto_mtls_secp256r1",
        mode="auto_mtls",
        curve="secp256r1",
        expected_result="success"
    ),
    MTLSConfig(
        name="auto_mtls_secp384r1", 
        mode="auto_mtls",
        curve="secp384r1",
        expected_result="success"
    ),
    ...
    MTLSConfig(
        name="manual_mtls_secp256r1",
        mode="manual_mtls",
        curve="secp256r1", 
        expected_result="success"
    ),
    MTLSConfig(
        name="manual_mtls_secp384r1",
        mode="manual_mtls",
        curve="secp384r1",
        expected_result="success"
    ),
...
def should_test_combination(client_server: ClientServerPair, mtls_config: MTLSConfig) -> bool:
    ...
    if (client_server.client_type == "python" and 
        mtls_config.curve == "secp521r1" and 
        mtls_config.mode == "auto_mtls"):
        return False
