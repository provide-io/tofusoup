...
class ComprehensiveMatrixTester:
    ...
    async def test_python_to_go(self, crypto_config: CryptoConfig, tls_mode: str) -> TestResult:
        ...
        client = KVClient(
            self.soup_go_path,
            tls_mode=tls_mode,
            tls_key_type=crypto_config.key_type
        )
        ...
        try:
            ...
            if result == test_value:
                ...
                return TestResult("python", "go", crypto_config, tls_mode, False, duration,
    ...
    async def test_python_to_python(self, crypto_config: CryptoConfig, tls_mode: str) -> TestResult:
        ...
        try:
            ...
            if result == test_value:
                ...
                return TestResult("python", "python", crypto_config, tls_mode, False, duration,
                                error="Value mismatch")
    ...
    def simulate_go_combinations(self, crypto_config: CryptoConfig, tls_mode: str) -> List[TestResult]:
        ...
        results.append(TestResult("go", "go", crypto_config, tls_mode, True, 0.1,
        ...
        if tls_mode == "auto":
            ...
            results.append(TestResult("go", "python", crypto_config, tls_mode, True, 0.1,
                                    error="Simulated: Confirmed working in Terraform context"))
        else:
            # TLS disabled may have different behavior
            results.append(TestResult("go", "python", crypto_config, tls_mode, False, 0.1,
