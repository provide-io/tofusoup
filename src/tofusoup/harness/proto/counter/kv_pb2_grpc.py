...
def add_CounterServicer_to_server(servicer, server) -> None:
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler("proto.Counter", rpc_method_handlers)
...
class AddHelperServicer:
    ...
    def Sum(self, request, context) -> Never:
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")
...
def add_AddHelperServicer_to_server(servicer, server) -> None:
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler("proto.AddHelper", rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
