...
STIR_TEST_SECRET = "stir-test-secret"  # noqa: S105 - test constant, not a real secret
...
ENV_PYVIDER_PRIVATE_STATE_SHARED_SECRET = "PYVIDER_PRIVATE_STATE_SHARED_SECRET"  # noqa: S105 - env var name, not a secret value
